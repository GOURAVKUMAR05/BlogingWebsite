                ...
                <div className='flex w-[1400px] mx-auto py-4  text-[white] justify-between px-3 items-center'>
                    ...
                    <div className=''>
                        <ul className='flex gap-16 text-lg cursor-pointer'>
                            <li className='hover:text-[#45ce55]  font-bold capitalize'><Link href="/" >Blog</Link></li>
                            <li className='hover:text-[#45ce55]  font-bold capitalize'><Link href="/Create" >Create</Link></li>
                            <li className='hover:text-[#45ce55]  font-bold capitalize'><Link href="/Listing" >Listing</Link></li>

                            {token!==undefined && token!==null && token!==""
                            
                            ?
                                <li><button onClick={()=>setToken('')} className='bg-white hover:bg-gray-100 text-gray-800 font-semibold py-1 px-4 border border-gray-400 rounded shadow'>Log Out</button></li>
                            :
